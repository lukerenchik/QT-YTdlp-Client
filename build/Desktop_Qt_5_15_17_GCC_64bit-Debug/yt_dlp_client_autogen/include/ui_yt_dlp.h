...
public:
    ...
    void setupUi(QMainWindow *yt_dlp)
    {
        ...
        actionInstallYtDlp = new QAction(yt_dlp);
        actionInstallYtDlp->setObjectName(QString::fromUtf8("actionInstallYtDlp"));
        ...
        menuSettings->addAction(actionInstallYtDlp);
    ...
    void retranslateUi(QMainWindow *yt_dlp)
    {
        ...
        actionInstallYtDlp->setText(QCoreApplication::translate("yt_dlp", "Install YtDlp", nullptr));
